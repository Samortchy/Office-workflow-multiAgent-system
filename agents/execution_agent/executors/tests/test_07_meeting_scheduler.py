...
def test_07_meeting_scheduler():
    ...
    envelope = {
        ...
        "task": {"task_id": "T007", "title": "Test Task", "description": "Test description", "department": "cross-dept", "isAutonomous": False, "task_type": "test", "requester_name": "John Doe", "stated_deadline": "2026-05-04", "action_required": "action", "success_criteria": "success", "structured_at": "2026-05-03T10:05:00Z"},
